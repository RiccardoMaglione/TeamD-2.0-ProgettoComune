...
public class DialogueType2 : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        if (collision.CompareTag("Player") && dialogueStarted == false && killToActivateDialogue <= FindObjectOfType<KilledEnemyCounter>().killedEnemyCounter)
        {
            ...
            playerDialogueBox.GetComponent<RectTransform>().anchoredPosition = new Vector2(-630, -150);
            bossDialogueBox.GetComponent<RectTransform>().anchoredPosition = new Vector2(2070, -150);
    ...
    private IEnumerator PlayerDialogueIn()
    {
        ...
        {
            playerDialogueBox.GetComponent<RectTransform>().anchoredPosition = Vector2.MoveTowards(new Vector2(playerDialogueBox.GetComponent<RectTransform>().anchoredPosition.x, playerDialogueBox.GetComponent<RectTransform>().anchoredPosition.y), new Vector2(-130, -150), speedTransition * Time.unscaledDeltaTime);
            if (playerDialogueBox.GetComponent<RectTransform>().anchoredPosition == new Vector2(-130, -150))
            {
    ...
    private IEnumerator PlayerDialogueOut()
    {
        ...
        {
            playerDialogueBox.GetComponent<RectTransform>().anchoredPosition = Vector2.MoveTowards(new Vector2(playerDialogueBox.GetComponent<RectTransform>().anchoredPosition.x, playerDialogueBox.GetComponent<RectTransform>().anchoredPosition.y), new Vector2(-630, -150), speedTransition * Time.unscaledDeltaTime);
            yield return null;
        }
    }
    private IEnumerator BossDialogueIn()
    {
        ...
        {
            bossDialogueBox.GetComponent<RectTransform>().anchoredPosition = Vector2.MoveTowards(new Vector2(bossDialogueBox.GetComponent<RectTransform>().anchoredPosition.x, bossDialogueBox.GetComponent<RectTransform>().anchoredPosition.y), new Vector2(1520, -150), speedTransition * Time.unscaledDeltaTime);
            if (bossDialogueBox.GetComponent<RectTransform>().anchoredPosition == new Vector2(1520, -150))
            {
                yield return new WaitForSecondsRealtime(dialogueUpTime);
    ...
    private IEnumerator BossDialogueOut()
    {
        ...
        {
            bossDialogueBox.GetComponent<RectTransform>().anchoredPosition = Vector2.MoveTowards(new Vector2(bossDialogueBox.GetComponent<RectTransform>().anchoredPosition.x, bossDialogueBox.GetComponent<RectTransform>().anchoredPosition.y), new Vector2(2070, -150), speedTransition * Time.unscaledDeltaTime);
            if (bossDialogueBox.GetComponent<RectTransform>().anchoredPosition == new Vector2(2070, -150))
            {
