...
public class PSMJump : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        else if (animator.GetComponent<PSMController>().RB2D.velocity.y > 1 && !Input.GetKey(KeyBinding.KeyBindSet(KeyBinding.KeyBindInstance.StringKeyUp)))                                                                                                //Altrimenti se la velocità è maggiore di 1 e non sto più schiacciando il pulsante spazio - Da un minimo di velocà di salto minimo - Permette di fare salti graduali
        {
